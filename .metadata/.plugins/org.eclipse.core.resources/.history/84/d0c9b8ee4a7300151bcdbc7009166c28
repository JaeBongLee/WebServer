...
public class StringCalculatorTest {
	...
	public void add_emptyString() {
		int result = stringCal.addInnerTextNumbers("");
		assertEquals(0,result);
	}

	@Test
	public void add_oneNumString() {
		int result = stringCal.addInnerTextNumbers("1");
	...
	public void add_twoNumberSumStringByComma() {
		int result = stringCal.addInnerTextNumbers("1,2");
		assertEquals(3,result);
	}
	
	@Test
	public void add_multiNumberSumStringByComma() {
		int result = stringCal.addInnerTextNumbers("1,2,3");
